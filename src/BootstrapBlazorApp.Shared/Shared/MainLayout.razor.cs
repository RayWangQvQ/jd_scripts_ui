    ...
    public sealed partial class MainLayout
    {
        ...
        private static List<MenuItem> GetIconSideMenuItems()
        {
            var menus = new List<MenuItem>
            {
                ...
                new MenuItem() { Text = "自定义shell", Icon = "fa fa-fw fa-wrench", Url = "customshell" },
                new MenuItem() { Text = "日志", Icon = "fa fa-fw fa-bug", Url = "customshell" },
                new MenuItem() { Text = "终端", Icon = "fa fa-fw fa-window-maximize", Url = "customshell" },
            };
